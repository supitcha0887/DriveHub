...
class Company:
    ...
    def register(self, username, password, role):
        ...
        if role in ["driver", "renter"]:  # ตรวจสอบเฉพาะที่มีใน Frontend
            if role == "driver":
...
# ฟังก์ชันสำหรับการเริ่มต้นข้อมูลตัวอย่าง (init data)
def init_data():
...
# ส่วนทดสอบ (Test Code) สำหรับทุก ๆ attribute และ method
